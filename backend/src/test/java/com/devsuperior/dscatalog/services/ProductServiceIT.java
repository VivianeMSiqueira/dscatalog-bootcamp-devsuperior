...
public class ProductServiceIT {
	...
	public void findAllPagedShouldReturnPageWhenPage0Size10() {
		...
		Page<ProductDTO> result = service.findAllPaged(pageRquest);
	...
	public void findAllPagedShouldReturnEmptyWhenPageDoesNotExist() {
		...
		PageRequest pageRquest = PageRequest.of(50, 10);
		Page<ProductDTO> result = service.findAllPaged(pageRquest);
	...
	public void findAllPagedShouldReturnsortedPageWhenSortByName() {
		...
		PageRequest pageRquest = PageRequest.of(0, 10, Sort.by("name"));
		Page<ProductDTO> result = service.findAllPaged(pageRquest);
